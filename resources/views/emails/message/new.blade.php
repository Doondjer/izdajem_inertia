                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;table-layout: fixed">
                                ...
                                <tr>
                                    <td valign="bottom" align="left" style="padding:30px 0 10px 0; font-family:helvetica neue,helvetica,arial,sans-serif;font-size:16px;line-height:20px;font-weight:bold;color:#a7a7a7">
                                        ...
                                        @else
                                            {{ trans('email.There is a new message in your message board from user :username, regarding', ['username' => ucwords(Auth::user() ? Auth::user()->name : trans('email.guest'))]) }}:
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <tr>
                                <td width="580" align="left" style="padding:30px 30px 20px 30px">
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse">
                                        <tbody>
                                            <tr>
                                                <td valign="bottom" height="75" align="left">
                                                    <img width="75" height="75" border="0" style="text-decoration:none;display:block;outline:none" src="{{ asset( config('imagecache.route') . '/75x75/' . (Auth::user() ? Auth::user()->profile_image : config('app_settings.values.default_profile_image'))) }}">
                                                </td>
                                                <td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse">
                                                        ...
                                                        <tr>
                                                            <td style="font-size:32px;line-height:36px;padding:0 0 0 0;font-family:helvetica neue,helvetica,arial,sans-serif;font-weight:bold;color:#444444;max-width:510px;overflow:hidden;text-overflow:ellipsis">
                                                                <span style="color:#bd081c"> @ {{ ucwords(Auth::user() ? Auth::user()->name : trans('email.guest')) }}</span>
                                                                {{ trans('email.message...')}}
                                                            </td>
                                                        </tr>
                                                        @if(isset($sender))
