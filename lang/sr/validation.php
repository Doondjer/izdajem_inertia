...
return [
    ...
    */
     ...
     * My validation
     */
    'expenses_rule' => 'Ne smeju biti odabrana polja u pojedinačnim troškovima, kada je odabrano polje ukupni troškovi.',
    'expenses_required_if' => 'Polje :attribute je obavezno kada je odabrano :value.',
    'morate_prvo_definisati_ovaj_trosak' => 'Morate prvo definisati ovaj trošak.',
    ...
    */
    ...
    'attributes' => [
        ...
        'heatings'              => 'grejanje',
        'type'                  => 'vrsta objekta',
        'furnish_type'          => 'nameštenost',
        'nb_bedroom'            => 'broj spavaćih soba',
        'nb_floor'              => 'sprat',
        'total_floor'           => 'ukupno spratova',
        'nb_room'               => 'struktura',
        'renovation'            => 'renoviranje',
        'ceiling_height'        => 'visina plafona',
        'year_manufacture'      => 'godina gradnje',
        'size'                  => 'površina',
        'expenses'              => 'troškovi',
        'parkings'              => 'parking',
        'addl_spaces'           => 'dodatni prostor',
        'pets'                  => 'dozvoljeni ljubimci',
        'available_from'        => 'useljivo od',
        'lease_min_moths'       => 'minimalni zakup',
        'payment_interval'      => 'period plaćanja',
        'street'                => 'ulica',
        'street_nb'             => 'broj ulice',
        'district'              => 'opština',
        'county'                => 'okrug',
        'images'                => 'slike',
        'price'                 => 'cena',
        'amenities'             => 'opremljenost',
        'securities'            => 'sigurnost',
    ...
    'ne_mozete_izmeniti_potvrdjeno_ili_odbijeno_razgledanje' => 'Ne možete izmeniti prethodno potvrdjeno ili odbijeno razgledanje.'
];
